...
rsync -avtbr --delete-excluded --min-size=100k --filter='protect respaldo_*' OWGIS_server:/PATH_NCMWS/config.xml  /$PATH_BACKUP/my_folder_backup/my_folder_owgis_config

rsync -avtbr --delete-excluded --filter='protect my_folder_backup*' OWGIS_server:/PATH_NCMWS/palettes /$PATH_BACKUP/my_folder_backup/my_folder_owgis_config
